...
#define CEU_UINT16_PRINTF_MODIFIER "u"
#else
#error "Failed to define ceu_uint16_t! Checked: unsigned short, unsigned short int, unsigned int, unsigned"
#endif
...
#warning "Failed to define ceu_int64_t! Checked: signed long, long, signed long int, long int, signed long long, long long, signed long long int, long long int"
#endif
...
typedef ceu_int64_t ceu_intmax_t;
#define INTMAX_MIN INT64_MIN
#define INTMAX_MAX INT64_MAX
#else
typedef ceu_int32_t ceu_intmax_t;
#define INTMAX_MIN INT32_MIN
#define INTMAX_MAX INT32_MAX
#endif

#ifdef CEU_HAVE_UINT64
typedef ceu_uint64_t ceu_uintmax_t;
#define UINTMAX_MAX UINT64_MAX
#else
typedef ceu_uint32_t ceu_uintmax_t;
