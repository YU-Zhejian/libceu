...
#ifdef CEU_CXX_STD_MACRO
    ceu_ystr_t* cstd_macro = ceu_ystr_from_uint(10, CEU_CXX_STD_MACRO);
#else
    ceu_ystr_t* cstd_macro = ceu_ystr_create_from_cstr("_MSVC_LANG and __cplusplus undefined");
#endif
    ceu_ystr_cstr_concat_inplace(rets, " (");
    ceu_ystr_concat_inplace(rets, cstd_macro);
    ceu_ystr_cstr_concat_inplace(rets, ")");
