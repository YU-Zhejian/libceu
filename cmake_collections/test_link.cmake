...
execute_process(
        ...
        --stop-on-failure
        --build-and-test
        "${CMAKE_CURRENT_LIST_DIR}/test_link_proj_static"
        "${CMAKE_BINARY_DIR}/test_link_proj_static"
        --build-generator
        "${CMAKE_GENERATOR}"
...
if(NOT CEU_CM_TRY_COMP_LINK_STATIC_RETV EQUAL 0)
    set(CEU_CM_TRY_COMP_LINK_STATIC FALSE CACHE INTERNAL "doc")
else()
...
execute_process(
        ...
        --stop-on-failure
        --build-and-test
        "${CMAKE_CURRENT_LIST_DIR}/test_link_proj_shared"
        "${CMAKE_BINARY_DIR}/test_link_proj_shared"
        --build-generator
        "${CMAKE_GENERATOR}"
        --test-command ctest -C Debug
