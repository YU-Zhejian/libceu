...
if(NOT DEFINED LIBLZMA_LIBRARY_SHARED)
    ceu_cm_enhanced_find_library(OUTPUT_VARIABLE CMAKE_CM_LIBLZMA_LIBRARY_SHARED PKGCONFIG_NAME liblzma LINKER_FLAG
                                 lzma)
endif()
...
if(NOT DEFINED LIBLZMA_LIBRARY_STATIC)
    ceu_cm_enhanced_find_library(
        STATIC
        OUTPUT_VARIABLE
        CMAKE_CM_LIBLZMA_LIBRARY_STATIC
        PKGCONFIG_NAME
        liblzma
        LINKER_FLAG
        lzma)
...
ceu_cm_enhanced_try_run(
    ...
    LINK_LIBRARIES
    "${CMAKE_CM_LIBLZMA_LIBRARY_SHARED}"
    DEPENDS
    C_HELLOWORLD)
ceu_cm_enhanced_try_run(
    STATIC
