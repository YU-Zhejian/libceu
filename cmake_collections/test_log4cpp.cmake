...
if (LOG4CPP_LIBRARY_SHARED AND (${HAVE_WORKING_CXX_STDTHREAD_RUN_SHARED} EQUAL 0))
    enhanced_try_run(VARNAME LOG4CPP SRC_PATH "test_log4cpp.cpp" LINK_LIBRARIES ${LOG4CPP_LIBRARY_SHARED} Threads::Threads)
else ()
    set(HAVE_WORKING_LOG4CPP_RUN_SHARED 127 CACHE INTERNAL "doc")
    set(HAVE_WORKING_LOG4CPP_COMPILE_SHARED FALSE CACHE INTERNAL "doc")
endif ()
if (LOG4CPP_LIBRARY_STATIC AND (${HAVE_WORKING_CXX_STDTHREAD_RUN_STATIC} EQUAL 0))
    enhanced_try_run(STATIC VARNAME LOG4CPP SRC_PATH "test_log4cpp.cpp" LINK_LIBRARIES ${LOG4CPP_LIBRARY_STATIC} Threads::Threads)
else ()
    set(HAVE_WORKING_LOG4CPP_RUN_STATIC 127 CACHE INTERNAL "doc")
    set(HAVE_WORKING_LOG4CPP_COMPILE_STATIC FALSE CACHE INTERNAL "doc")
endif ()

print_test_status("log4cpp" LOG4CPP LOG4CPP)
